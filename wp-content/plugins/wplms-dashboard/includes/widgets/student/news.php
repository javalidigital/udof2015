...
class wplms_dash_news extends WP_Widget {
    ...
    $this->WP_Widget( 'wplms_dash_news', __(' DASHBOARD : Member News', 'wplms-dashboard'), $widget_ops, $control_ops );
    ...
    function register_essentials(){
          ...
          array(
            'labels' => array(
              'name' => __('News','wplms-dashboard'),
              'menu_name' => __('News','wplms-dashboard'),
              'singular_name' => __('News','wplms-dashboard'),
              'add_new_item' => __('Add News','wplms-dashboard'),
              'all_items' => __('All News','wplms-dashboard')
            ),
            'public' => true,
